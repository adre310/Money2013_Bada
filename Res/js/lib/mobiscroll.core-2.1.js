    ...
    function Scroller(elm, settings) {
        ...
        */
        that.setValue = function (sc, fill, time, temp) {
        	console.log('that.setValue '+sc+','+fill+','+time+','+temp);
            if (!temp) {
            	console.log('that.temp '+that.temp);
            	console.log('that.temp.slice '+that.temp.slice);
    ...
    var scrollers = {},
        ...
        methods = {
            ...
            setValue: function (d, fill, time, temp) {
            	console.log('setValue '+d+','+fill+','+time+','+temp);
                return this.each(function () {
                    var inst = getInst(this);
                    if (inst) {
                        inst.temp = d;
                    	console.log('setValue inst.temp '+d);
